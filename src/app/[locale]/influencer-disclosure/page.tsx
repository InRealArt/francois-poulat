...
export async function generateMetadata(
  props: DisclosurePageProps
): Promise<Metadata> {
  const { locale } = await props.params;
  const t = await getTranslations({
    locale: locale as Locale,
    namespace: "influencerDisclosure",
  });
...
export default async function InfluencerDisclosurePage({
  params,
}: DisclosurePageProps) {
  ...
  const t = await getTranslations("influencerDisclosure");
